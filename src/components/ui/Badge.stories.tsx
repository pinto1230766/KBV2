  ...
  render: () => (
    <div className="space-y-4">
      <p>
        ...
        <Badge variant="primary" size="sm">inline badge</Badge>
        {' '}that flows with the text.
      </p>
      <p>
        Another example with{' '}
        <Badge variant="success" size="sm">success status</Badge>
        {' '}showing completion.
      </p>
    </div>
  ),
      ...
      <div className="relative">
        <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center">
          <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM9 17H4l5 5v-5zM15 7h5l-5 5v-5zM9 7H4l5 5v-5z" />
          </svg>
        </div>
