...
export const HotkeysHelpModal: React.FC<HotkeysHelpModalProps> = ({ isOpen, onClose, hotkeys }) => {
        ...
        <div className='p-6 overflow-y-auto max-h-[calc(90vh-120px)]'>
                          ...
                          <React.Fragment key={i}>
                            ...
                            >
                              {k.charAt(0).toUpperCase() +
                                k.slice(1).replace('ctrl', 'Ctrl').replace('shift', 'Shift')}
                            </kbd>
                            {i < arr.length - 1 && (
          ...
          <div className='mt-6 p-4 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg'>
            <p className='text-sm text-primary-900 dark:text-primary-100'>
              💡 <strong>Astuce:</strong> Appuyez sur{' '}
              <kbd className='px-2 py-1 text-xs font-semibold bg-white dark:bg-gray-800 border border-primary-300 dark:border-primary-700 rounded'>
                Shift
              </kbd>{' '}
              +{' '}
              <kbd className='px-2 py-1 text-xs font-semibold bg-white dark:bg-gray-800 border border-primary-300 dark:border-primary-700 rounded'>
