...
const QUICK_ACTIONS: ActionItem[] = [
  { id: 'schedule-visit', label: 'Programmer une visite', description: 'Créer une nouvelle visite rapidement', icon: Calendar, color: 'text-blue-600', bg: 'bg-blue-100 dark:bg-blue-900/40', category: 'planning' },
  { id: 'check-conflicts', label: 'Vérifier les conflits', description: 'Détecter les conflits de planning', icon: Zap, color: 'text-orange-600', bg: 'bg-orange-100 dark:bg-orange-900/40', category: 'planning' },
  ...
  { id: 'add-host', label: 'Ajouter un hôte', description: "Enregistrer un nouveau contact d'accueil", icon: Users, color: 'text-purple-600', bg: 'bg-purple-100 dark:bg-purple-900/40', category: 'contacts' },
  ...
  { id: 'generate-report', label: 'Générer un rapport', description: 'Créer un rapport personnalisé', icon: FileText, color: 'text-indigo-600', bg: 'bg-indigo-100 dark:bg-indigo-900/40', category: 'data' },
  { id: 'backup-data', label: 'Sauvegarder les données', description: 'Créer une sauvegarde complète', icon: Settings, color: 'text-gray-600', bg: 'bg-gray-100 dark:bg-gray-900/40', category: 'data' },
  { id: 'import-data', label: 'Importer des données', description: 'Importer depuis un fichier CSV', icon: Plus, color: 'text-teal-600', bg: 'bg-teal-100 dark:bg-teal-900/40', category: 'data' },
  ...
  { id: 'show-statistics', label: 'Voir Statistiques', description: 'Graphiques et insights détaillés', icon: TrendingUp, color: 'text-purple-600', bg: 'bg-purple-100 dark:bg-purple-900/40', category: 'data' },
];
