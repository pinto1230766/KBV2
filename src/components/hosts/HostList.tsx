...
import { Edit, Trash2, Phone, Mail, MapPin, Info, Car, Building, Dog } from 'lucide-react';
          ...
          <Card key={host.nom} hoverable>
            <CardBody className='p-4'>
              ...
              <div className='mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 flex flex-wrap gap-2'>
                ...
                {host.hasElevator && (
                  <span className='px-2 py-1 bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300 rounded-full text-xs font-medium flex items-center gap-1'>
                    <Building className='w-3 h-3' />
                    {t('Ascenseur')}
                  </span>
                )}
                {host.hasPets && (
                  <span className='px-2 py-1 bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300 rounded-full text-xs font-medium flex items-center gap-1'>
