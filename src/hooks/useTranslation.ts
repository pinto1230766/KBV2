...
const translations = {
  fr: {
    ...
    'Nous tenons à vous remercier chaleureusement pour votre accueil lors de nos visites. Votre hospitalité et votre disponibilité ont beaucoup compté pour nous.': 'Nous tenons à vous remercier chaleureusement pour votre accueil lors de nos visites. Votre hospitalité et votre disponibilité ont beaucoup compté pour nous.',
    'Que Dieu vous bénisse,': 'Que Dieu vous bénisse,',
    'L\'assemblée de Lyon': 'L\'assemblée de Lyon',
    'L\'assemblée de Lyon recherche des frères et sœurs disponibles pour accueillir des visiteurs lors de nos réunions.': 'L\'assemblée de Lyon recherche des frères et sœurs disponibles pour accueillir des visiteurs lors de nos réunions.',
    'Auriez-vous la possibilité d\'accueillir des visiteurs ? Votre aide serait très appréciée.': 'Auriez-vous la possibilité d\'accueillir des visiteurs ? Votre aide serait très appréciée.',
    ...
    'Veuillez saisir un nom pour le modèle et un message': 'Veuillez saisir un nom pour le modèle et un message',
    ...
    'Type': 'Type',
    'Demande d\'accueil': 'Demande d\'accueil',
    'Remerciements': 'Remerciements',
    'Message libre': 'Message libre',
    'Confirmation': 'Confirmation',
    'Rappel (J-7)': 'Rappel (J-7)',
    'Rappel (J-2)': 'Rappel (J-2)',
  ...
  cv: {
    ...
    'Nous tenons à vous remercier chaleureusement pour votre accueil lors de nos visites. Votre hospitalité et votre disponibilité ont beaucoup compté pour nous.': 'Nós queremos agradecer-vos calorosamente pelo acolhimento durante as nossas visitas. A vossa hospitalidade e disponibilidade contaram muito para nós.',
    'Que Dieu vous bénisse,': 'Que Deus vos abençoe,',
    'L\'assemblée de Lyon': 'A assembleia de Lyon',
    'L\'assemblée de Lyon recherche des frères et sœurs disponibles pour accueillir des visiteurs lors de nos réunions.': 'A assembleia de Lyon está à procura de irmãos e irmãs disponíveis para acolher visitantes durante as nossas reuniões.',
    'Auriez-vous la possibilité d\'accueillir des visiteurs ? Votre aide serait très appréciée.': 'Teriam a possibilidade de acolher visitantes? A vossa ajuda seria muito apreciada.',
    ...
    'Sauvegarder': 'Guardar',
    'Veuillez saisir un nom pour le modèle et un message': 'Por favor introduza um nome para o modelo e uma mensagem',
  ...
  pt: {
    ...
    // Messages pour les hôtes (modèles)
    'Chers frères et sœurs,': 'Queridos irmãos e irmãs,',
    'Nous tenons à vous remercier chaleureusement pour votre accueil lors de nos visites. Votre hospitalité et votre disponibilité ont beaucoup compté pour nous.': 'Queremos agradecer calorosamente pelo acolhimento durante as nossas visitas. A vossa hospitalidade e disponibilidade contaram muito para nós.',
    'Que Dieu vous bénisse,': 'Que Deus vos abençoe,',
    'L\'assemblée de Lyon': 'A assembleia de Lyon',
    'L\'assemblée de Lyon recherche des frères et sœurs disponibles pour accueillir des visiteurs lors de nos réunions.': 'A assembleia de Lyon está à procura de irmãos e irmãs disponíveis para acolher visitantes durante as nossas reuniões.',
    'Auriez-vous la possibilité d\'accueillir des visiteurs ? Votre aide serait très appréciée.': 'Teriam a possibilidade de acolher visitantes? A vossa ajuda seria muito apreciada.',
