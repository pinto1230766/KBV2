...
import { Plus, Users, Home, Search, Filter, Download, Mic2, UserCheck } from 'lucide-react';
    ...
    <div className='space-y-6 max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6'>
        ...
        <div>
          <div className='flex items-center gap-2 mb-2'>
            ...
            <span className='text-gray-400 text-xs font-medium'>
              {activeTab === 'speakers' ? 'Orateurs' : 'Hébergement'}
            </span>
          </div>
      ...
      <div className='grid grid-cols-2 lg:grid-cols-4 gap-4'>
        ...
        <StatCard
          ...
          colorClasses={{
            ...
            iconBg: 'bg-white dark:bg-teal-900/30',
          }}
        />
        <StatCard
          icon={UserCheck}
      ...
      <div className='sticky top-20 z-30 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl p-2 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col md:flex-row gap-2'>
        ...
        <div className='relative flex-1 group'>
          ...
          <input
            type='text'
            placeholder={
              activeTab === 'speakers' ? 'Rechercher un orateur...' : 'Rechercher un hôte...'
            }
            value={searchTerm}
      ...
      <div className='min-h-[500px] animate-in fade-in duration-500'>
        {activeTab === 'speakers' ? (
          ...
          <div className='bg-transparent'>
            <HostList
              hosts={hosts.filter((h) => h.nom.toLowerCase().includes(searchTerm.toLowerCase()))}
