import { W as l } from './index-D4MkNNtG.js';
import './react-vendor-B9D_A6Vq.js';
import './charts-CCOFnOOy.js';
...
class u extends l {
  ...
  async migrate() {
    ...
    const t = [],
      s = [],
      o = '_cap_',
      n = Object.keys(this.impl).filter((i) => i.indexOf(o) === 0);
    for (const i of n) {
      const r = i.substring(o.length),
        a = (e = this.impl.getItem(i)) !== null && e !== void 0 ? e : '',
        { value: p } = await this.get({ key: r });
      typeof p == 'string' ? s.push(r) : (await this.set({ key: r, value: a }), t.push(r));
    }
...
export { u as PreferencesWeb };
//# sourceMappingURL=web-C5S0Kc-Q.js.map
