    ...
    if (a === '/') {
      if (!(i === o - 1 || s === 1))
        if (s === 2) {
          ...
          (t.length > 0 ? (t += `/${n.slice(i + 1, o)}`) : (t = n.slice(i + 1, o)),
            (r = o - i - 1));
      ((i = o), (s = 0));
    } else a === '.' && s !== -1 ? ++s : (s = -1);
  }
        ...
        switch ((($ = E[E.length - 1]), $.tag)) {
                      ...
                      if (I.length === $.nesting) {
                        ((c.lastIndex = p),
                          ...
                          f[1] === '${'
                            ...
                            : (E.pop(),
                              (S = !0),
                              yield { type: 'TemplateTail', value: f[0], closed: f[1] === '`' }));
                        continue;
                      }
                      break;
                    case 'InterpolationInJSX':
            ...
            if (((c.lastIndex = p), (f = c.exec(_)))) {
              ((p = c.lastIndex),
                ...
                f[1] === '${'
                  ...
                  : ((S = !0),
                    yield { type: 'NoSubstitutionTemplate', value: f[0], closed: f[1] === '`' }));
              continue;
            }
            break;
          case 'JSXTag':
          case 'JSXTagEnd':
            ...
            if (((r.lastIndex = p), (f = r.exec(_)))) {
              ((p = r.lastIndex),
                (m = f[0]),
                yield { type: 'JSXString', value: f[0], closed: f[2] !== void 0 });
              continue;
            }
            break;
          case 'JSXChildren':
...
function he(n) {
  ...
  let r = t[1];
  if (
    (r.startsWith('async ') && (r = r.slice(6)), r.startsWith('http:') || r.startsWith('https:'))
  ) {
    const i = new URL(r);
...
function et(n) {
  ...
  return !s || !a || !o
    ? null
    : { file: s, method: i || '', line: Number.parseInt(a), column: Number.parseInt(o) };
}
function tt(n) {
  const e = n.trim();
  ...
  return {
    hoisted(r) {
      if (typeof r != 'function')
        throw new TypeError(`vi.hoisted() expects a function, but received a ${typeof r}`);
      return r();
    },
    mock(r, i) {
      if (typeof r != 'string')
        throw new TypeError(`vi.mock() expects a string path, but received a ${typeof r}`);
      const s = A('mock');
      t().queueMock(r, s, typeof i == 'function' ? () => i(() => t().importActual(r, s)) : i);
    },
    unmock(r) {
      if (typeof r != 'string')
        throw new TypeError(`vi.unmock() expects a string path, but received a ${typeof r}`);
      t().queueUnmock(r, A('unmock'));
    },
    doMock(r, i) {
      if (typeof r != 'string')
        throw new TypeError(`vi.doMock() expects a string path, but received a ${typeof r}`);
      const s = A('doMock');
      t().queueMock(r, s, typeof i == 'function' ? () => i(() => t().importActual(r, s)) : i);
    },
    doUnmock(r) {
      if (typeof r != 'string')
        throw new TypeError(`vi.doUnmock() expects a string path, but received a ${typeof r}`);
...
class it {
  ...
  async invalidate() {
    ...
    e.length &&
      (await this.rpc.invalidate(e), await this.interceptor.invalidate(), this.registry.clear());
  }
  async importActual(e, t) {
    ...
    return this.wrapDynamicImport(() => import(o)).then((l) => {
      ...
      return d?.__esModule
        ? d
        : {
            ...((typeof d == 'object' && !Array.isArray(d)) || typeof d == 'function' ? d : {}),
            default: d,
          };
    });
  }
  ...
  mockObject(e, t = 'automock') {
    return ye(
      { globalConstructors: { Object, Function, Array, Map, RegExp }, spyOn: this.spyOn, type: t },
      e
    );
  }
  queueMock(e, t, r) {
    const i = this.rpc
      ...
      .then(
        async ({ redirectUrl: s, resolvedId: a, resolvedUrl: o, needsInterop: l, mockType: d }) => {
